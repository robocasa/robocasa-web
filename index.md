...
<aside class="rc-home-updates" aria-label="Updates">
  ...
  <ul class="rc-home-updates__list">
    ...
    <li><span class="rc-home-updates__date">[4/6/2026]</span> The <a href="{{ site.baseurl }}/leaderboard.html"><strong>RoboCasa365 Leaderboard</strong></a> is live, comparing generalist robot policies on the multi-task learning benchmark and open to community model submissions.</li>
